...
<details>
  <summary><b>🛠️ 사용 도구 및 인프라 확인하기 (Click to Expand)</b></summary>
  <br/>
...
<details>
  <summary><b>🛠️ 기술 스택 및 대표 프로젝트 확인하기 (Click to Expand)</b></summary>
  <br/>
...
<div align="center">
  ...
  <a href="https://github.com/Hamm-JH"><img src="./images/board-row-0.svg" width="100%" alt="(Sample) WebGL 기초와 렌더링 파이프라인 이해하기" /></a><br/>
  <a href="https://github.com/Hamm-JH"><img src="./images/board-row-1.svg" width="100%" alt="(Sample) 트랜스포머(Transformer) 모델의 어텐션 메커니즘" /></a><br/>
  <a href="https://github.com/Hamm-JH"><img src="./images/board-row-2.svg" width="100%" alt="(Sample) Next.js 14 App Router 마이그레이션 경험기" /></a><br/>
  <a href="https://github.com/Hamm-JH"><img src="./images/board-row-3.svg" width="100%" alt="(Sample) 마이크로서비스 아키텍처에서의 이벤트 기반 통신" /></a><br/>
  <a href="https://github.com/Hamm-JH"><img src="./images/board-row-4.svg" width="100%" alt="(Sample) PostgreSQL 인덱스 설계 가이드" /></a>
</div>
<!-- blog ends -->
